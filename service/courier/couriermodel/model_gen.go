...
func (t *linkModelTable) GetLinkModelEqCreatorIDOrdCreationTime(ctx context.Context, d db.SQLExecutor, creatorid string, orderasc bool, limit, offset int) (_ []LinkModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *brandModelTable) GetBrandModelEqCreatorIDOrdCreationTime(ctx context.Context, d db.SQLExecutor, creatorid string, orderasc bool, limit, offset int) (_ []BrandModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
