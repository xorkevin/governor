...
func (t *apikeyModelTable) GetModelEqKeyid(ctx context.Context, d sqldb.Executor, keyid string) (*Model, error) {
	m := &Model{}
...
func (t *apikeyModelTable) DelEqKeyid(ctx context.Context, d sqldb.Executor, keyid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE keyid = $1;", keyid)
	return err
}

func (t *apikeyModelTable) DelHasKeyid(ctx context.Context, d sqldb.Executor, keyids []string) error {
	paramCount := 0
...
func (t *apikeyModelTable) GetModelEqUseridOrdTime(ctx context.Context, d sqldb.Executor, userid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *apikeyModelTable) UpdapikeyHashEqKeyid(ctx context.Context, d sqldb.Executor, m *apikeyHash, keyid string) error {
...
func (t *apikeyModelTable) UpdapikeyPropsEqKeyid(ctx context.Context, d sqldb.Executor, m *apikeyProps, keyid string) error {
