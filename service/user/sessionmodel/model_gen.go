...
func (t *sessionModelTable) GetModelEqSessionID(ctx context.Context, d sqldb.Executor, sessionid string) (*Model, error) {
	m := &Model{}
...
func (t *sessionModelTable) UpdModelEqSessionID(ctx context.Context, d sqldb.Executor, m *Model, sessionid string) error {
...
func (t *sessionModelTable) DelEqSessionID(ctx context.Context, d sqldb.Executor, sessionid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE sessionid = $1;", sessionid)
	return err
}

func (t *sessionModelTable) DelHasSessionID(ctx context.Context, d sqldb.Executor, sessionids []string) error {
	paramCount := 0
...
func (t *sessionModelTable) DelEqUserid(ctx context.Context, d sqldb.Executor, userid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE userid = $1;", userid)
	return err
}

func (t *sessionModelTable) GetModelEqUseridOrdTime(ctx context.Context, d sqldb.Executor, userid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *sessionModelTable) GetqIDEqUseridOrdSessionID(ctx context.Context, d sqldb.Executor, userid string, orderasc bool, limit, offset int) (_ []qID, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
