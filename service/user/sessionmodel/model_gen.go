...
func (t *sessionModelTable) GetModelEqUseridOrdTime(ctx context.Context, d db.SQLExecutor, userid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *sessionModelTable) GetqIDEqUseridOrdSessionID(ctx context.Context, d db.SQLExecutor, userid string, orderasc bool, limit, offset int) (_ []qID, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
