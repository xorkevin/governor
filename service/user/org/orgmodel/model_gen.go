...
func (t *orgModelTable) GetModelEqOrgID(ctx context.Context, d sqldb.Executor, orgid string) (*Model, error) {
	m := &Model{}
...
func (t *orgModelTable) GetModelHasOrgIDOrdOrgID(ctx context.Context, d sqldb.Executor, orgids []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 2
...
func (t *orgModelTable) UpdModelEqOrgID(ctx context.Context, d sqldb.Executor, m *Model, orgid string) error {
...
func (t *orgModelTable) DelEqOrgID(ctx context.Context, d sqldb.Executor, orgid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE orgid = $1;", orgid)
	return err
}

func (t *orgModelTable) GetModelEqName(ctx context.Context, d sqldb.Executor, name string) (*Model, error) {
	m := &Model{}
...
func (t *orgModelTable) GetModelOrdCreationTime(ctx context.Context, d sqldb.Executor, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) DelEqOrgID(ctx context.Context, d sqldb.Executor, orgid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE orgid = $1;", orgid)
	return err
}

func (t *memberModelTable) DelEqUseridHasOrgID(ctx context.Context, d sqldb.Executor, userid string, orgids []string) error {
	paramCount := 1
	args := make([]interface{}, 0, paramCount+len(orgids))
...
func (t *memberModelTable) GetMemberModelEqUseridOrdName(ctx context.Context, d sqldb.Executor, userid string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) GetMemberModelEqUseridLikeNameOrdName(ctx context.Context, d sqldb.Executor, userid string, namePrefix string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) GetMemberModelEqOrgIDOrdUsername(ctx context.Context, d sqldb.Executor, orgid string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) GetMemberModelEqOrgIDLikeUsernameOrdUsername(ctx context.Context, d sqldb.Executor, orgid string, usernamePrefix string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) UpdorgNameEqOrgID(ctx context.Context, d sqldb.Executor, m *orgName, orgid string) error {
...
func (t *memberModelTable) UpdmemberUsernameEqUserid(ctx context.Context, d sqldb.Executor, m *memberUsername, userid string) error {
