...
func (t *orgModelTable) GetModelHasOrgIDOrdOrgID(ctx context.Context, d db.SQLExecutor, orgids []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 2
...
func (t *orgModelTable) GetModelOrdCreationTime(ctx context.Context, d db.SQLExecutor, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) GetMemberModelEqUseridOrdName(ctx context.Context, d db.SQLExecutor, userid string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) GetMemberModelEqUseridLikeNameOrdName(ctx context.Context, d db.SQLExecutor, userid string, namePrefix string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) GetMemberModelEqOrgIDOrdUsername(ctx context.Context, d db.SQLExecutor, orgid string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *memberModelTable) GetMemberModelEqOrgIDLikeUsernameOrdUsername(ctx context.Context, d db.SQLExecutor, orgid string, usernamePrefix string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
