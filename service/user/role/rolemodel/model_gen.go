...
func (t *roleModelTable) GetModelEqRoleOrdUserid(ctx context.Context, d sqldb.Executor, role string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *roleModelTable) DelEqUserid(ctx context.Context, d sqldb.Executor, userid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE userid = $1;", userid)
	return err
}

func (t *roleModelTable) GetModelEqUseridEqRole(ctx context.Context, d sqldb.Executor, userid string, role string) (*Model, error) {
	m := &Model{}
...
func (t *roleModelTable) GetModelEqUseridOrdRole(ctx context.Context, d sqldb.Executor, userid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *roleModelTable) GetModelEqUseridHasRoleOrdRole(ctx context.Context, d sqldb.Executor, userid string, roles []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 3
...
func (t *roleModelTable) GetModelEqUseridLikeRoleOrdRole(ctx context.Context, d sqldb.Executor, userid string, rolePrefix string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *roleModelTable) DelEqRoleHasUserid(ctx context.Context, d sqldb.Executor, role string, userids []string) error {
	paramCount := 1
...
func (t *roleModelTable) DelEqUseridEqRole(ctx context.Context, d sqldb.Executor, userid string, role string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE userid = $1 AND role = $2;", userid, role)
	return err
}

func (t *roleModelTable) DelEqUseridHasRole(ctx context.Context, d sqldb.Executor, userid string, roles []string) error {
	paramCount := 1
	args := make([]interface{}, 0, paramCount+len(roles))
