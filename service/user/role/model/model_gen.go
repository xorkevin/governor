...
func roleModelGetModelEqUseridRole(db *sql.DB, userid string, role string) (*Model, int, error) {
	m := &Model{}
...
func roleModelDelEqUseridRole(db *sql.DB, userid string, role string) error {
