...
func (t *profileModelTable) GetModelEqUserid(ctx context.Context, d sqldb.Executor, userid string) (*Model, error) {
	m := &Model{}
...
func (t *profileModelTable) GetModelHasUseridOrdUserid(ctx context.Context, d sqldb.Executor, userids []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 2
...
func (t *profileModelTable) UpdModelEqUserid(ctx context.Context, d sqldb.Executor, m *Model, userid string) error {
...
func (t *profileModelTable) DelEqUserid(ctx context.Context, d sqldb.Executor, userid string) error {
