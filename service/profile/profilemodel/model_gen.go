...
func (t *profileModelTable) GetModelHasUseridOrdUserid(ctx context.Context, d db.SQLExecutor, userids []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 2
