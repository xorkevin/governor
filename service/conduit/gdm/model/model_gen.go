...
func (t *gdmModelTable) GetModelHasChatidOrdChatid(ctx context.Context, d db.SQLExecutor, chatids []string, orderasc bool, limit, offset int) ([]Model, error) {
	paramCount := 2
...
func (t *memberModelTable) GetMemberModelEqUseridHasChatidOrdChatid(ctx context.Context, d db.SQLExecutor, userid string, chatids []string, orderasc bool, limit, offset int) ([]MemberModel, error) {
	paramCount := 3
	args := make([]interface{}, 0, paramCount+len(chatids))
...
func (t *memberModelTable) GetMemberModelHasChatidOrdChatid(ctx context.Context, d db.SQLExecutor, chatids []string, orderasc bool, limit, offset int) ([]MemberModel, error) {
	paramCount := 2
	args := make([]interface{}, 0, paramCount+len(chatids))
	args = append(args, limit, offset)
	var placeholderschatids string
...
func (t *memberModelTable) GetMemberModelEqChatidHasUseridOrdUserid(ctx context.Context, d db.SQLExecutor, chatid string, userids []string, orderasc bool, limit, offset int) ([]MemberModel, error) {
	paramCount := 3
