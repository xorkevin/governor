...
func (t *channelModelTable) GetChannelModelEqServerIDOrdChannelID(ctx context.Context, d db.SQLExecutor, serverid string, orderasc bool, limit, offset int) (_ []ChannelModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *channelModelTable) GetChannelModelEqServerIDLikeChannelIDOrdChannelID(ctx context.Context, d db.SQLExecutor, serverid string, channelidPrefix string, orderasc bool, limit, offset int) (_ []ChannelModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *presenceModelTable) GetPresenceModelEqServerIDGtLastUpdatedOrdLastUpdated(ctx context.Context, d db.SQLExecutor, serverid string, lastupdated int64, orderasc bool, limit, offset int) (_ []PresenceModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
