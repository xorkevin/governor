...
func (t *serverModelTable) GetModelByID(ctx context.Context, d sqldb.Executor, serverid string) (*Model, error) {
	m := &Model{}
...
func (t *serverModelTable) DelByID(ctx context.Context, d sqldb.Executor, serverid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE serverid = $1;", serverid)
	return err
}

func (t *serverModelTable) UpdserverPropsByID(ctx context.Context, d sqldb.Executor, m *serverProps, serverid string) error {
...
func (t *channelModelTable) Setup(ctx context.Context, d sqldb.Executor) error {
	_, err := d.ExecContext(ctx, "CREATE TABLE IF NOT EXISTS "+t.TableName+" (serverid VARCHAR(31), channelid VARCHAR(31), chatid VARCHAR(31) UNIQUE, name VARCHAR(255) NOT NULL, desc VARCHAR(255), theme VARCHAR(4095) NOT NULL, creation_time BIGINT NOT NULL, PRIMARY KEY (serverid, channelid));")
	if err != nil {
		return err
	}
	return nil
...
func (t *channelModelTable) DelByServer(ctx context.Context, d sqldb.Executor, serverid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE serverid = $1;", serverid)
	return err
}

func (t *channelModelTable) GetChannelModelByServerChannel(ctx context.Context, d sqldb.Executor, serverid string, channelid string) (*ChannelModel, error) {
	m := &ChannelModel{}
...
func (t *channelModelTable) GetChannelModelByServer(ctx context.Context, d sqldb.Executor, serverid string, limit, offset int) (_ []ChannelModel, retErr error) {
	res := make([]ChannelModel, 0, limit)
	rows, err := d.QueryContext(ctx, "SELECT serverid, channelid, chatid, name, desc, theme, creation_time FROM "+t.TableName+" WHERE serverid = $3 ORDER BY channelid LIMIT $1 OFFSET $2;", limit, offset, serverid)
	if err != nil {
		return nil, err
	}
	defer func() {
...
func (t *channelModelTable) GetChannelModelByServerChannelPrefix(ctx context.Context, d sqldb.Executor, serverid string, channelidPrefix string, limit, offset int) (_ []ChannelModel, retErr error) {
	res := make([]ChannelModel, 0, limit)
	rows, err := d.QueryContext(ctx, "SELECT serverid, channelid, chatid, name, desc, theme, creation_time FROM "+t.TableName+" WHERE serverid = $3 AND channelid LIKE $4 ORDER BY channelid LIMIT $1 OFFSET $2;", limit, offset, serverid, channelidPrefix)
	if err != nil {
		return nil, err
	}
	defer func() {
...
func (t *channelModelTable) DelByServerChannels(ctx context.Context, d sqldb.Executor, serverid string, channelids []string) error {
	paramCount := 1
...
func (t *channelModelTable) UpdchannelPropsByServerChannel(ctx context.Context, d sqldb.Executor, m *channelProps, serverid string, channelid string) error {
...
func (t *presenceModelTable) Setup(ctx context.Context, d sqldb.Executor) error {
	_, err := d.ExecContext(ctx, "CREATE TABLE IF NOT EXISTS "+t.TableName+" (serverid VARCHAR(31), userid VARCHAR(31), last_updated BIGINT NOT NULL, PRIMARY KEY (serverid, userid));")
	if err != nil {
		return err
	}
	_, err = d.ExecContext(ctx, "CREATE INDEX IF NOT EXISTS "+t.TableName+"_server_last_updated_index ON "+t.TableName+" (serverid, last_updated);")
	if err != nil {
		return err
	}
	return nil
...
func (t *presenceModelTable) DelByServer(ctx context.Context, d sqldb.Executor, serverid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE serverid = $1;", serverid)
	return err
}

func (t *presenceModelTable) GetPresenceModelByServerAfterLastUpdated(ctx context.Context, d sqldb.Executor, serverid string, lastupdated int64, limit, offset int) (_ []PresenceModel, retErr error) {
	res := make([]PresenceModel, 0, limit)
	rows, err := d.QueryContext(ctx, "SELECT serverid, userid, last_updated FROM "+t.TableName+" WHERE serverid = $3 AND last_updated > $4 ORDER BY last_updated DESC LIMIT $1 OFFSET $2;", limit, offset, serverid, lastupdated)
	if err != nil {
		return nil, err
	}
	defer func() {
...
func (t *presenceModelTable) DelByServerBeforeLastUpdated(ctx context.Context, d sqldb.Executor, serverid string, lastupdated int64) error {
