...
func memberModelGetMemberModelEqUseridEqKindLtLastUpdatedOrdLastUpdated(db *sql.DB, tableName string, userid string, kind string, lastupdated int64, orderasc bool, limit, offset int) ([]MemberModel, error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
