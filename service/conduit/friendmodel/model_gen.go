...
func (t *friendModelTable) GetModelEqUserid1HasUserid2OrdUserid2(ctx context.Context, d db.SQLExecutor, userid1 string, userid2s []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 3
...
func (t *friendModelTable) GetModelEqUserid1OrdUsername(ctx context.Context, d db.SQLExecutor, userid1 string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *friendModelTable) GetModelEqUserid1LikeUsernameOrdUsername(ctx context.Context, d db.SQLExecutor, userid1 string, usernamePrefix string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
