...
func (t *invModelTable) GetModelEqInvitedByGtCreationTimeOrdCreationTime(ctx context.Context, d db.SQLExecutor, invitedby string, creationtime int64, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
