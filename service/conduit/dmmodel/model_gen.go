...
func (t *dmModelTable) GetModelEqUserid1EqUserid2(ctx context.Context, d sqldb.Executor, userid1 string, userid2 string) (*Model, error) {
	m := &Model{}
...
func (t *dmModelTable) DelEqUserid1EqUserid2(ctx context.Context, d sqldb.Executor, userid1 string, userid2 string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE userid_1 = $1 AND userid_2 = $2;", userid1, userid2)
	return err
}

func (t *dmModelTable) GetModelEqChatid(ctx context.Context, d sqldb.Executor, chatid string) (*Model, error) {
	m := &Model{}
...
func (t *dmModelTable) GetModelHasChatidOrdLastUpdated(ctx context.Context, d sqldb.Executor, chatids []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 2
...
func (t *dmModelTable) UpddmPropsEqUserid1EqUserid2(ctx context.Context, d sqldb.Executor, m *dmProps, userid1 string, userid2 string) error {
...
func (t *dmModelTable) UpddmLastUpdatedEqUserid1EqUserid2(ctx context.Context, d sqldb.Executor, m *dmLastUpdated, userid1 string, userid2 string) error {
