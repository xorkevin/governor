...
func (t *msgModelTable) GetModelEqChatidOrdMsgid(ctx context.Context, d db.SQLExecutor, chatid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *msgModelTable) GetModelEqChatidLtMsgidOrdMsgid(ctx context.Context, d db.SQLExecutor, chatid string, msgid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *msgModelTable) GetModelEqChatidEqKindOrdMsgid(ctx context.Context, d db.SQLExecutor, chatid string, kind string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *msgModelTable) GetModelEqChatidEqKindLtMsgidOrdMsgid(ctx context.Context, d db.SQLExecutor, chatid string, kind string, msgid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
