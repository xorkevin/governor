...
func (t *msgModelTable) GetModelEqChatidOrdMsgid(ctx context.Context, d sqldb.Executor, chatid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *msgModelTable) GetModelEqChatidLtMsgidOrdMsgid(ctx context.Context, d sqldb.Executor, chatid string, msgid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *msgModelTable) GetModelEqChatidEqKindOrdMsgid(ctx context.Context, d sqldb.Executor, chatid string, kind string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *msgModelTable) GetModelEqChatidEqKindLtMsgidOrdMsgid(ctx context.Context, d sqldb.Executor, chatid string, kind string, msgid string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *msgModelTable) DelEqChatid(ctx context.Context, d sqldb.Executor, chatid string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE chatid = $1;", chatid)
	return err
}

func (t *msgModelTable) UpdmsgValueEqChatidHasMsgid(ctx context.Context, d sqldb.Executor, m *msgValue, chatid string, msgids []string) error {
	paramCount := 2
