...
func (t *gdmModelTable) GetModelHasChatidOrdChatid(ctx context.Context, d db.SQLExecutor, chatids []string, orderasc bool, limit, offset int) (_ []Model, retErr error) {
	paramCount := 2
...
func (t *memberModelTable) GetMemberModelEqUseridHasChatidOrdChatid(ctx context.Context, d db.SQLExecutor, userid string, chatids []string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	paramCount := 3
	args := make([]interface{}, 0, paramCount+len(chatids))
...
func (t *memberModelTable) GetMemberModelHasChatidOrdChatid(ctx context.Context, d db.SQLExecutor, chatids []string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	paramCount := 2
	args := make([]interface{}, 0, paramCount+len(chatids))
	args = append(args, limit, offset)
	var placeholderschatids string
...
func (t *memberModelTable) GetMemberModelEqChatidHasUseridOrdUserid(ctx context.Context, d db.SQLExecutor, chatid string, userids []string, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	paramCount := 3
...
func (t *memberModelTable) DelEqChatidHasUserid(ctx context.Context, d db.SQLExecutor, chatid string, userids []string) error {
	paramCount := 1
	args := make([]interface{}, 0, paramCount+len(userids))
...
func (t *memberModelTable) GetMemberModelEqUseridLtLastUpdatedOrdLastUpdated(ctx context.Context, d db.SQLExecutor, userid string, lastupdated int64, orderasc bool, limit, offset int) (_ []MemberModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
...
func (t *assocModelTable) DelEqChatidHasUserid1(ctx context.Context, d db.SQLExecutor, chatid string, userid1s []string) error {
	paramCount := 1
...
func (t *assocModelTable) DelEqChatidHasUserid2(ctx context.Context, d db.SQLExecutor, chatid string, userid2s []string) error {
	paramCount := 1
...
func (t *assocModelTable) GetAssocModelEqUserid1EqUserid2OrdLastUpdated(ctx context.Context, d db.SQLExecutor, userid1 string, userid2 string, orderasc bool, limit, offset int) (_ []AssocModel, retErr error) {
	order := "DESC"
	if orderasc {
		order = "ASC"
	}
