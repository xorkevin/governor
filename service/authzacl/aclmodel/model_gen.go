...
func (t *aclModelTable) Setup(ctx context.Context, d db.SQLExecutor) error {
...
func (t *aclModelTable) Insert(ctx context.Context, d db.SQLExecutor, m *Model) error {
...
func (t *aclModelTable) InsertBulk(ctx context.Context, d db.SQLExecutor, models []*Model, allowConflict bool) error {
	conflictSQL := ""
	if allowConflict {
...
func (t *aclModelTable) DelEqObjNSEqObjKey(ctx context.Context, d db.SQLExecutor, objns string, objkey string) error {
	_, err := d.ExecContext(ctx, "DELETE FROM "+t.TableName+" WHERE obj_ns = $1 AND obj_key = $2;", objns, objkey)
	return err
}

func (t *aclModelTable) DelEqSubNSEqSubKeyEqSubPred(ctx context.Context, d db.SQLExecutor, subns string, subkey string, subpred string) error {
